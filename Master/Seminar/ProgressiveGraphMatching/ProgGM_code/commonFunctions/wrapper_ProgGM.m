function [ score_GM runningTime X_sol Xraw cand_matchlist perform_data affinityMatrix_final ] = wrapper_ProgGM( pparam, method, cdata, extrapolation_dist )
...
for iterGM = 1:maxIterGM
    ...
    nDetected = nnz(X_sol_EXT);    nTrue = nnz(X_GT);  
