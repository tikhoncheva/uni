...
\begin{itemize}
\item set of candidate correspondences
...
\visible<3->{Similar works:
			\begin{itemize}
				\item semisupervised case~\cite{Lyzinski2015}
				\item another objective function~\cite{Hancock_ModalClusters,Hancock_GM_SpectralPart}
				\item special kind of subproblem~\cite{Hancock_GM_SpectralPart,CliqueGraph_CVPR2015}
			\end{itemize}}
\end{itemize}
\end{frame}
%--------------------------------------------------------------------------%
...
\begin{figure} [h]
	\centering
	\includegraphics[scale=0.35]{fig/twolevels3.png}
\end{figure}
\end{frame}
%--------------------------------------------------------------------------%
\begin{frame}
