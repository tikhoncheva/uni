...
geometric dissimilarities defined as~\eqref{eq:geomDiss}. At the end, the close correspondences build bigger clusters and likely represent inliers. In contrast to that, the outliers are likely to stay in small groups, so we can threshold them base on the cluster size.
