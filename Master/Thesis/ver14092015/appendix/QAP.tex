...
\end{align*}
The first and the last term are obviously constant, and thus can be ignored in optimization. Finally, substitution of $F=-(A^I)^T$, $D=(A^J)^T$ leads us to the formulation~\eqref{eq:QAP_classic3}. That is exactly, what we wanted to show.
