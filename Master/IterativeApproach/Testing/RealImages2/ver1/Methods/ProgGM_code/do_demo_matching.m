...
fname1 = '../../data/img_trafo/set1/sun_aafpznbwiqbmolft_a1.png'; % reference image
fname2 = '../../data/img_trafo/set1/sun_aafpznbwiqbmolft_b.png'; % reference image

% fname1 = './data_demo/building_1.png'; % test image
