function [ featInfo ] = extract_localfeatures_mcho_without_keypoints_location( featInfo, filePathName, fparam)
% modification of the function
% [ featInfo ] = extract_localfeatures_mcho( filePathName, fparam, bShowFeat )
% without extraction of the interest points
