...
iparam.dataFolder = '/export/home/etikhonc/Documents/Databases/house/';

switch 1
    %% for the house test sequence
    case 1 
        file_to_load = [iparam.dataFolder, 'groundT.mat'];
...
%             testDataFile = [ listOfModelDataFile(cImg).name] ;        
...
%         
%         %% save ground truth for testing proposes
%         resultTag = [ iparam.view(1).fileName '+' iparam.view(2).fileName ];
%         initPathnFile = [ iparam.dataFolder '/' 'fi_' resultTag '.mat' ];
%         save(initPathnFile, 'cdata'); 
% 
