function [ matchInfo ] =  make_initialmatches2(descrImg1, descrImg2, mparam)

% Find kNN matches between feature sets
...
tic
[ tmpInitialMatch, tmpSimInitialMatch ] = matchSIFTdescr( descrImg1, descrImg2, mparam.kNN);
...
if nMatches > 0
    ...
    simInitialMatch = [ simInitialMatch tmpSimInitialMatch ];
end
