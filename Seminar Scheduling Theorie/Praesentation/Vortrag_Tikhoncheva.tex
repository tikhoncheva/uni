...
\vspace{10pt}
 \begin{tikzpicture}
     \node [block, text width=2.8cm] at (-5,-0.5) (S1) {\centering I\\ Zimmer III ist leer.};
     
     \node [block, text width=4.0cm] at (-1.2, - 0.5)(S2) {\centering II\\ Der Tiger ist im Zimmer I.};
     
     \node [block, text width=3.5cm] at ( 3.0,-0.5) (S3) {\centering III\\ Dieses Zimmer ist leer.};
  \end{tikzpicture}
...
\begin{tikzpicture}
	\node [block, text width=5.1cm] at (2, 0.5)(IP) 
	{
		...
		\begin{itemize}
		 ...
		 \item gesucht wird eine Menge der Nebenbedingungen, die ausreichend ist, um den Kernpunkt des Problems zu beschreiben
		 \end{itemize}
	};
	\node [block,text width=5.cm] at (7.5, 0.5)(CP) 
	{
